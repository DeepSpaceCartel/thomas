...
A real, deployed FastAPI app used to exercise Thomas's HTTP testing
mechanism (`.agents/skills/thomas-bdd-testing/rest/REFERENCE.md`).
Every design choice here was deliberate and is worth preserving when
extending it.
