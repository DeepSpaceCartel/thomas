...
- [ ] Added a real entry under `## [Unreleased]` in `CHANGELOG.md` (see `.agents/skills/keepachangelog`) — skip only for changes with nothing user-facing to note (typo fixes, internal refactors with no behavior change).
