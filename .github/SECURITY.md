...
Include what you'd include in any real bug report: the real command or
scenario that exposes the issue, the version/commit you're on, and the
actual vs. expected behavior.

## Supported Versions

Thomas is pre-1.0 — only the latest released version is supported.
